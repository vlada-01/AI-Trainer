...
@router.post('/engine', response_model=JobResponse)
async def prepare_engine(request: Request, run_id: str, data: requests.PrepareTrainJobRequest):
    try:
...
async def prepare_copmplete_train(request: Request, run_id: str, data: requests.PrepareCompleteTrainJobRequest):
    try:
