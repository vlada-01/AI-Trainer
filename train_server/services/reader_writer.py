...
PATHS_MAP = {
    'data_cfg_rel_path': Path('cfgs/data_cfg.json'),
    'model_cfg_rel_path': Path('cfgs/model_cfg.json'),
    'train_cfg_rel_path': Path('cfgs/train_cfg.json'),
    'model_state_rel_path': Path('model/model.pt'),
    'pp_cfg_rel_path': Path('predictor/pp_cfg.json'),
    'meta_rel_path': Path('meta/meta.json'),
...
class ArtifactWriter:
    ...
    # FIXME: update this to store .csv
